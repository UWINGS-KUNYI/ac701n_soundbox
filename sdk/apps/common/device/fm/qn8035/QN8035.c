...
#if TCFG_CLK_OUT_TO_EXFM_ENABLE
    /* 开时钟给外挂 FM 芯片，提供时钟 */
    extern void clk_out(u8 gpio, enum CLK_OUT_SOURCE clk);
    clk_out(IO_PORTG_00, BTOSC_24M_CLK_OUT);
#endif
...
#if TCFG_CLK_OUT_TO_EXFM_ENABLE
    /* 关闭外挂 FM 芯片时钟 */
    extern int gpio_och_disable_output_signal(u32 gpio, enum OUTPUT_CH_SIGNAL signal);
    gpio_och_disable_output_signal(IO_PORTG_00, OUTPUT_CH_SIGNAL_CLOCK_OUT0);
#endif
