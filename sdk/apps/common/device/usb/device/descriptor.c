...
#if (MIC_AUDIO_RATE != 48000) && (TCFG_AUDIO_DAC_BIT_WIDTH == DAC_24BIT_MODE)
    'U', 'F',     // idProduct: chip id
#elif (MIC_AUDIO_RATE != 48000) && (TCFG_AUDIO_DAC_BIT_WIDTH != DAC_24BIT_MODE)
    'U', 'C',     // idProduct: chip id
#elif (MIC_AUDIO_RATE == 48000) && (TCFG_AUDIO_DAC_BIT_WIDTH != DAC_24BIT_MODE)
    'U', 'D',     // idProduct: chip id
#else
    'U', 'E',     // idProduct: chip id
#endif
