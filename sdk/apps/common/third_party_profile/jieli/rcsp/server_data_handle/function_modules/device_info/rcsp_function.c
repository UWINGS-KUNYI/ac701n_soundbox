...
#if ((RCSP_MODE == RCSP_MODE_EARPHONE) || (RCSP_MSG_DISTRIBUTION_VER == RCSP_MSG_DISTRIBUTION_VER_VISUAL_CFG_TOOL))
#include "event.h"
#endif
...
static void common_function_attr_adaptive_noise_reduction(void *priv, u8 attr, u8 *data, u16 len)
{
    ...
    /* printf("LXF switch_adaptive_noise_reduction:%x", *switch_adaptive_noise_reduction); */
    if (*switch_adaptive_noise_reduction) {
        /* printf("LXF %s, %d", __FUNCTION__, __LINE__); */
        u8 *is_adaptive_noise_reduction_check = data + 1;
        /* printf("LXF is_adaptive_noise_reduction_check:%x", *is_adaptive_noise_reduction_check); */
...
static const attr_set_func common_function_set_tab[COMMON_FUNCTION_ATTR_TYPE_MAX] = {
    ...
    [COMMON_FUNCTION_ATTR_TYPE_EQ_INFO				          ] = common_function_attr_eq_set,
    ...
    [COMMON_FUNCTION_ATTR_TYPE_ADAPTIVE_NOISE_REDUCTION       ] = common_function_attr_adaptive_noise_reduction,
};
...
static u32 common_function_attr_adaptive_noise_reduction_info_get(void *priv, u8 attr, u8 *buf, u16 buf_size, u32 offset)
{
    u32 rlen = 0;
#if RCSP_ADV_ADAPTIVE_NOISE_REDUCTION
    /* printf("LXF1 %s, %d", __FUNCTION__, __LINE__); */
    ...
    offset += add_one_attr(buf, buf_size, offset, attr, adaptive_noise_reduction_info, sizeof(adaptive_noise_reduction_info));
#endif
    return rlen;
}
...
static const attr_get_func target_common_function_get_tab[COMMON_FUNCTION_ATTR_TYPE_MAX] = {
    ...
    [COMMON_FUNCTION_ATTR_TYPE_ADAPTIVE_NOISE_REDUCTION       ] = common_function_attr_adaptive_noise_reduction_info_get,
};
...
void rcsp_function_setting_stop(void)
{
