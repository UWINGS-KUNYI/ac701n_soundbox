...
enum {
    ...
    COMMON_FUNCTION_ATTR_TYPE_ADAPTIVE_NOISE_REDUCTION				= 21,
    COMMON_FUNCTION_ATTR_TYPE_AI_NO_PICK							= 22,
    COMMON_FUNCTION_ATTR_TYPE_SCENE_NOISE_REDUCTION					= 23,
    COMMON_FUNCTION_ATTR_TYPE_WIND_NOISE_DETECTION					= 24,
    COMMON_FUNCTION_ATTR_TYPE_VOICE_ENHANCEMENT_MODE				= 25,
