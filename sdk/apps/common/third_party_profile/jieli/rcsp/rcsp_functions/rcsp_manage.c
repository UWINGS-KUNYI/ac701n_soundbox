...
#else // !(RCSP_MSG_DISTRIBUTION_VER == RCSP_MSG_DISTRIBUTION_VER_VISUAL_CFG_TOOL)
...
#endif // !(RCSP_MSG_DISTRIBUTION_VER == RCSP_MSG_DISTRIBUTION_VER_VISUAL_CFG_TOOL)
...
int JL_rcsp_event_handler(struct rcsp_event *rcsp)
{
    ...
    case MSG_JL_ADV_SETTING_SYNC:
        printf("MSG_JL_ADV_SETTING_SYNC\n");
        update_rcsp_setting(-1);
        break;
    case MSG_JL_ADV_SETTING_UPDATE:
        printf("MSG_JL_ADV_SETTING_UPDATE\n");
        update_info_from_vm_info();
        break;
    case MSG_JL_UPDATE_EQ:
        rcsp_function_update(COMMON_FUNCTION, BIT(COMMON_FUNCTION_ATTR_TYPE_EQ_INFO));
        break;
    ...
    case  MSG_JL_UPDATE_MUSIC_PLAYER_TIME_TEMER:
        printf("MSG_JL_UPDATE_MUSIC_PLAYER_TIME_TEMER\n");
        if (JL_rcsp_get_auth_flag()) {
    ...
    case MSG_JL_UPDATE_ANC_VOICE:
        ...
        rcsp_function_update(COMMON_FUNCTION, (BIT(COMMON_FUNCTION_ATTR_TYPE_ANC_VOICE) | BIT(COMMON_FUNCTION_ATTR_TYPE_ADAPTIVE_NOISE_REDUCTION)));
#else
        rcsp_function_update(COMMON_FUNCTION, BIT(COMMON_FUNCTION_ATTR_TYPE_ANC_VOICE));
#endif
        break;
    ...
    case MSG_JL_UPDATE_ADAPTIVE_NOISE_REDUCTION:
        ...
        rcsp_function_update(COMMON_FUNCTION, BIT(COMMON_FUNCTION_ATTR_TYPE_ADAPTIVE_NOISE_REDUCTION));
        break;
#endif
