...
extern void rcsp_c_cmd_recieve(void *priv, u8 opCode, u8 opCode_SN, u8 *data, u16 len);
extern void rcsp_c_cmd_recieve_no_response(void *priv, u8 opCode, u8 *data, u16 len);
extern void rcsp_c_cmd_response(void *priv, u8 opCode, u8 status, u8 *data, u16 len);

#else // RCSP_BLE_MASTER

extern void rcsp_cmd_recieve(void *priv, u8 OpCode, u8 OpCode_SN, u8 *data, u16 len);
extern void rcsp_cmd_recieve_no_respone(void *priv, u8 OpCode, u8 *data, u16 len);
extern void rcsp_cmd_respone(void *priv, u8 OpCode, u8 status, u8 *data, u16 len);
extern void rcsp_data_recieve(void *priv, u8 OpCode_SN, u8 CMD_OpCode, u8 *data, u16 len);
extern void rcsp_data_recieve_no_respone(void *priv, u8 CMD_OpCode, u8 *data, u16 len);
extern void rcsp_data_respone(void *priv, u8 status, u8 CMD_OpCode, u8 *data, u16 len);
...
#if RCSP_BLE_MASTER
    .bt_3th_handler.CMD_resp          = rcsp_c_cmd_recieve,
    .bt_3th_handler.CMD_no_resp       = rcsp_c_cmd_recieve_no_response,
    .bt_3th_handler.CMD_recieve_resp  = rcsp_c_cmd_response,
    .bt_3th_handler.DATA_resp         = NULL,
    .bt_3th_handler.DATA_no_resp      = NULL,
    .bt_3th_handler.DATA_recieve_resp = NULL,

#else // RCSP_BLE_MASTER

    .bt_3th_handler.CMD_resp          = rcsp_cmd_recieve,
    .bt_3th_handler.CMD_no_resp       = rcsp_cmd_recieve_no_respone,
    .bt_3th_handler.CMD_recieve_resp  = rcsp_cmd_respone,
    .bt_3th_handler.DATA_resp         = rcsp_data_recieve,
    .bt_3th_handler.DATA_no_resp      = rcsp_data_recieve_no_respone,
    .bt_3th_handler.DATA_recieve_resp = rcsp_data_respone,
#endif // RCSP_BLE_MASTER
