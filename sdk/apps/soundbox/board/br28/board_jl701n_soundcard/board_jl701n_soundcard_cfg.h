#ifndef CONFIG_BOARD_JL701N_SOUNDCARD_CFG_H
#define CONFIG_BOARD_JL701N_SOUNDCARD_CFG_H

#include "board_jl701n_soundcard_global_build_cfg.h"

#ifdef CONFIG_BOARD_JL701N_SOUNDCARD
...
+--------------------+-------------------+-------------------+----------------------------+-------------------------+
*/
// #define TCFG_AUDIO_DAC_CONNECT_MODE             DAC_OUTPUT_MONO_L               //DAC_OUTPUT_LR
...
*/
#define TCFG_AUDIO_DAC_MODE                 DAC_MODE_L_DIFF
...
//配置MIC电源
#define TCFG_AUDIO_MIC_PWR_CTL              MIC_PWR_FROM_MIC_BIAS   //MIC_PWR_FROM_MIC_LDO
...
#define TCFG_MIC_EFFECT_START_DIR    	0//ENABLE//开机直接启动混响
...
#define MIC_EFFECT_LLNS      1//   ENABLE
...
#endif //CONFIG_BOARD_JL701N_SOUNDCARD
#endif //CONFIG_BOARD_JL701N_SOUNDCARD_CFG_H
