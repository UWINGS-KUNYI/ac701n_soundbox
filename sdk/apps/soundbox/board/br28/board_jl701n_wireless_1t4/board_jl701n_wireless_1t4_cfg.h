#ifndef CONFIG_BOARD_JL701N_WIRELESS_1T4_CFG_H
#define CONFIG_BOARD_JL701N_WIRELESS_1T4_CFG_H

#include "board_jl701n_wireless_1t4_global_build_cfg.h"

#ifdef CONFIG_BOARD_JL701N_WIRELESS_1T4
...
#define WIRELESS_1t4_EN                     ENABLE
#define ROLE_MASTER                         1
#define ROLE_SLAVE                          2
#define WIRELESS_1T4_ROLE                   ROLE_MASTER


#define L_CHANNEL                           1
#define R_CHANNEL                           2
#define WIRELESS_1T4_RECEVIER_DEC_CHANNEL   L_CHANNEL
#define WIRELESS_1T4_RECEVIER_BIS_CHANNEL   1
//*********************************************************************************//
//                                  app 配置                                       //
//*********************************************************************************//
...
#if (WIRELESS_1T4_ROLE == ROLE_MASTER)
#define BROADCAST_TX_LOCAL_DEC_EN   0   //广播音频发送端是否解码发送的音频
#define BROADCAST_FIXED_ROLE        1   //固定广播角色, 配0不固定角色，配1做发送端，配2做接收端
#define BROADCAST_TX_CHANNEL_SEPARATION     0   //发送端音频声道分离使能，要求发送端为双声道，接收端为单声道并且码率为发送端一半
#define BROADCAST_AUTO_SWITCH_ROLE  0   //播放和暂停自动切换发射和接收状态
#define BROADCAST_RECEIVER_CLOSE_EDR_CONN   0//广播从机关闭经典蓝牙连接
#define BIG_TX_USED_BIS_NUM         2
#define BIG_TX_PARAM_FROM           1
#define BIG_TX_PARAM_TX_DELAY       1500
#define BIG_MULTIPLE_ENCODER_EN     1
#elif (WIRELESS_1T4_ROLE == ROLE_SLAVE)
#define BROADCAST_TX_LOCAL_DEC_EN   0   //广播音频发送端是否解码发送的音频
#define BROADCAST_FIXED_ROLE        2   //固定广播角色, 配0不固定角色，配1做发送端，配2做接收端
#define BROADCAST_TX_CHANNEL_SEPARATION     0   //发送端音频声道分离使能，要求发送端为双声道，接收端为单声道并且码率为发送端一半
#define BROADCAST_AUTO_SWITCH_ROLE  0   //播放和暂停自动切换发射和接收状态
#define BROADCAST_RECEIVER_CLOSE_EDR_CONN   1//广播从机关闭经典蓝牙连接
#define BIG_RX_BIS_CHANNEL          WIRELESS_1T4_RECEVIER_BIS_CHANNEL
#define BIG_RX_PSYNC_TIME           5000
#define BROADCAST_DEC_OUTPUT_CHANNEL    WIRELESS_1T4_RECEVIER_DEC_CHANNEL
#else
...
#define JLA_CODING_FRAME_LEN   50    	//一帧编码的pcm时间长,只支持25，50，100,一帧编码的pcm时间长,单位ms  广播暂不支持修改;
#define JLA_CODING_BIT_RATE    128000  		//JLA 的码率 广播时 若码率大于96K,需要修改每次传输数据大小为 1 帧编码长度;
...
#define BIG_AUX_SDU_PERIOD_MS       10
#endif

#define TCFG_JLA_STREAM_CUSTOM_ADD_DELAY    5000L
...
#if (WIRELESS_1T4_ROLE == ROLE_MASTER)
#define TCFG_LINEIN_LR_CH					AUDIO_LIN0_LR|AUDIO_LIN1_LR
#else
#define TCFG_LINEIN_LR_CH					AUDIO_LIN0_LR
#endif
#define TCFG_LINEIN_DETECT_ENABLE           ENABLE
#define TCFG_LINEIN_CHECK_PORT				IO_PORTA_02				// linein检测IO
