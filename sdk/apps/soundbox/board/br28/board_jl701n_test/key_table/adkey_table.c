...
const u16 bt_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
        KEY_CALL_ANSWER, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_CALL_LAST_NO,	KEY_CALL_HANG_UP
    },
    [1] = {
        KEY_NULL,		 KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [2] = {
        KEY_CHANGE_MODE, KEY_NULL,			KEY_NULL,       	KEY_NULL,	    KEY_BROADCAST_SW,	KEY_NULL
    },
    [3] = {
        KEY_NULL,		KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
...
const u16 fm_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [6] = {
        KEY_FM_PREV_STATION, KEY_VOL_UP,	KEY_VOL_UP,	    	    KEY_NULL,		KEY_FM_PREV_FREQ,	KEY_NULL
    },
    [7] = {
        KEY_NULL,		KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [8] = {
        KEY_FM_NEXT_STATION, KEY_VOL_DOWN, KEY_VOL_DOWN,		    KEY_NULL,		KEY_FM_NEXT_FREQ,   KEY_NULL
    },
    [9] = {
        KEY_NULL,		KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
...
const u16 music_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [4] = {
        KEY_MUSIC_PP,	KEY_NULL,	        KEY_NULL,			KEY_NULL,		KEY_MUSIC_CHANGE_DEV,           KEY_NULL
    },
    [5] = {
        KEY_NULL,  		KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
...
const u16 record_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [0] = {
        ...
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_BROADCAST_SW,			KEY_NULL
...
const u16 rtc_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [0] = {
        ...
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,	    KEY_CONNECTED_SW,			KEY_WIRELESS_PAIR_INFO_REMOVE
#else
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_RTC_SW,			KEY_NULL
#endif
    },
    [1] = {
