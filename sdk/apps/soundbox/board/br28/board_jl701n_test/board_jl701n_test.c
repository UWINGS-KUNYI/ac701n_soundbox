...
STATUS_CONFIG status_config = {
    ...
    .led = {
        ...
        .bt_init_ok    = PWM_LED0_LED1_FAST_FLASH,//PWM_LED0_LED1_SLOW_FLASH,
        .bt_connect_ok = PWM_LED1_ONE_FLASH_5S,
        .bt_disconnect = PWM_LED0_LED1_FAST_FLASH,
        .tws_connect_ok = PWM_LED1_FAST_FLASH,
        .tws_disconnect = PWM_LED1_SLOW_FLASH,
    },
    //提示音设置
    .tone = {
...
#endif /* #ifdef CONFIG_BOARD_JL701N_TEST */
