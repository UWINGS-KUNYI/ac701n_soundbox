#ifndef CONFIG_BOARD_JL701N_KBOX_CFG_H
#define CONFIG_BOARD_JL701N_KBOX_CFG_H

#include "board_jl701n_kbox_global_build_cfg.h"

#ifdef CONFIG_BOARD_JL701N_KBOX
 ...
 * */
#define TCFG_AUDIO_DAC_BIT_WIDTH   		DAC_24BIT_MODE
...
#define TCFG_DYNAMIC_EQ_ENABLE              1     //动态EQ使能，接在EQ后，需输入32bit位宽数据
...
#define TCFG_AUDIO_MDRC_ENABLE              2     //多带DRC使能  0:关闭多带DRC，  1：使能多带DRC  2：使能多带DRC 并且 多带DRC后再做一次全带的drc
...
#define TCFG_MIC_HARMONIC_EXCITER_ENABLE 	1 //DISABLE//谐波激励器
...
#define AUDIO_VBASS_CONFIG        	1	//虚拟低音,虚拟低音不支持四声道
#define AUDIO_VBASS_32BIT_OUT_EN    1   //虚拟低音32bit位宽输出使能 0:16bit 1:32bit，开启32bit后不支持环绕声
...
#define TCFG_MUSIC_HARMONIC_EXCITER_ENABLE 	1//音乐通路谐波激励器
...
#endif //CONFIG_BOARD_JL701N_KBOX
#endif //CONFIG_BOARD_JL701N_KBOX_CFG_H
