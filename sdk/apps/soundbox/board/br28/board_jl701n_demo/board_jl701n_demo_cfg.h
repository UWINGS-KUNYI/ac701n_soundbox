...
#define TCFG_HOST_AUDIO_ENABLE				0//ENABLE_THIS_MOUDLE
...
#define TCFG_SD1_DET_IO                     IO_PORTB_03     //当检测方式为IO检测可用
...
#define AUDIO_DAC_IO_ENABLE                 DISABLE_THIS_MOUDLE
...
*/
#define TCFG_AUDIO_DAC_MODE           	DAC_MODE_H2_SINGLE

/*
 *DAC 位宽(bit width)配置
 *16bit：DAC_16BIT_MODE
 *24bit：DAC_24BIT_MODE
 * */
#define TCFG_AUDIO_DAC_BIT_WIDTH   		DAC_16BIT_MODE
...
#define SYS_VOL_TYPE            VOL_TYPE_DIGGROUP	//	VOL_TYPE_DIGITAL_HW
...
//如果同时开启mic_bias供电以及开启差分mic模式，为防止mic_bias供电与差分N端这同一引脚的两种功能冲突，使用其他mic的mic_bias脚进行供电(需要自己接线),默认：
// mic0差分用mic1的mic_bias脚（PA4）供电
// mic1差分用mic3的mic_bias脚（PG5）供电
// mic2差分用mic0的mic_bias脚（PA2）供电
// mic3差分用mic2的mic_bias脚（PG7）供电
// 可根据实际使用在audio_enc_init()函数中修改
...
#define TCFG_AUDIO_ADC_BIT_MODE             ADC_BIT_WIDTH_16
#define TCFG_ADC_BIT_24_TO_16               (0)

#if (TCFG_AUDIO_DAC_BIT_WIDTH == DAC_24BIT_MODE)
#undef TCFG_AUDIO_ADC_BIT_MODE
#define TCFG_AUDIO_ADC_BIT_MODE             ADC_BIT_WIDTH_24
#endif
/*
...
#if TCFG_PC_FOUR_MIC
#define TCFG_AUDIO_ADC_MIC_CHA				(AUDIO_ADC_MIC_0 | AUDIO_ADC_MIC_1 | AUDIO_ADC_MIC_2 | AUDIO_ADC_MIC_3)
...
#define TCFG_AUDIO_KWS_LANGUAGE_SEL    KWS_FAR_CH

//AudioEffects代码链接管理
#define AUDIO_EFFECTS_DRC_AT_RAM			1
#define AUDIO_EFFECTS_REVERB_AT_RAM			1
#define AUDIO_EFFECTS_ECHO_AT_RAM			0
#define AUDIO_EFFECTS_AFC_AT_RAM			1
#define AUDIO_EFFECTS_EQ_AT_RAM				1
#define AUDIO_EFFECTS_NOISEGATE_AT_RAM		1
#define AUDIO_EFFECTS_MIC_EFFECT_AT_RAM		1
#define AUDIO_EFFECTS_MIC_STREAM_AT_RAM		1
#define AUDIO_EFFECTS_DEBUG_AT_RAM			0
#define AUDIO_EFFECTS_DYNAMIC_EQ_AT_RAM     1
#define AUDIO_EFFECTS_VBASS_AT_RAM          1
#define AUDIO_EFFECTS_VOICE_CHANGER_AT_RAM  1
#define AUDIO_STREAM_AT_RAM                 1
#define AUDIO_EFFECTS_DVOL_AT_RAM           1
#define AUDIO_EFFECTS_CONVERT_DATA_AT_RAM   1
#define AUDIO_EFFECTS_HARMONIC_EXCITER_RAM  1
#define AUDIO_EFFECTS_GAIN_AT_RAM           1
#define AUDIO_PLC_AT_RAM                    1
...
#define TCFG_LCD_OLED_ENABLE				ENABLE_THIS_MOUDLE	// oled黑白点阵屏  // 使用 LED7 需要 DISABLE 此处
...
#define TCFG_SHARE_OSC_UART_PORT 			 IO_PORTA_00
...
#define TCFG_IIS_IN_MODE_EQ_ENABLE          1     //支持IIS输入模式EQ


#define EQ_SECTION_MAX                      10	  //EQ段数
#define TCFG_DYNAMIC_EQ_ENABLE              0     //动态EQ使能，接在EQ后，需输入32bit位宽数据
#if TCFG_DYNAMIC_EQ_ENABLE
#define  DYNAMIC_EQ_MAX_NSECTION             2    //动态eq支持的最大段数1或者2
#endif

#define TCFG_DYNAMIC_EQ_PRO_ENABLE          0     //动态EQ PRO使能，接在EQ后，需输入32bit位宽数据
#if TCFG_DYNAMIC_EQ_PRO_ENABLE//dyeq与dyeqPro共同使能时使用dyeqPro
#undef TCFG_DYNAMIC_EQ_ENABLE
#define TCFG_DYNAMIC_EQ_ENABLE 1
#endif
...
#define TCFG_IIS_IN_MODE_DRC_ENABLE         1     //支持IIS输入模式DRC
...
//广播mic 音效选择
#define WIRELESS_MIC_EFFECT_ENABLE       	DISABLE_THIS_MOUDLE
#define WIRELESS_MASTER_MIC_EFFECT_ENABLE   DISABLE //主机发送前做mic音效
#define WIRELESS_MIC_EFFECT_ASYNC_EN        DISABLE
#define WIRELESS_SLAVE_MIC_EFFECT_ENABLE    DISABLE //从机收到数据做mic音效
...
//使用MIC_EFFECT_REVERB_ECHO时，是否使能尾部多带DRC
#define TCFG_MIC_EFFECT_MDRC    0
#if (TCFG_MIC_EFFECT_SEL != MIC_EFFECT_REVERB_ECHO)
#undef TCFG_MIC_EFFECT_MDRC
#define TCFG_MIC_EFFECT_MDRC    0
#endif
...
//背景音乐闪避，音量类型使用数字音量组，且打开MIC_EFFECT_CONFIG_DVOL、MIC_EFFECT_CONFIG_ENERGY_DETECT
...
#define TCFG_MIC_HARMONIC_EXCITER_ENABLE 	DISABLE//谐波激励器

#if TCFG_MIC_EFFECT_ENABLE
#define TCFG_AUDIO_EFFECT_TASK_ENABLE       0
#else
#define TCFG_AUDIO_EFFECT_TASK_ENABLE       1
#endif
...
#define TCFG_BT_SUPPORT_LHDC                 	  0   //LHDC格式支持
...
#define CONFIG_LOCAL_TWS_ENABLE				0
...
#define BROADCAST_TX_LOCAL_DEC_EN   1   //广播音频发送端是否解码发送的音频
#define BROADCAST_RECEIVER_CLOSE_EDR_CONN   0//广播从机关闭经典蓝牙连接
#define BROADCAST_FIXED_ROLE        0   //固定广播角色, 配0不固定角色，配1做发送端，配2做接收端
#define BROADCAST_TX_CHANNEL_SEPARATION     0   //发送端音频声道分离使能，要求发送端为双声道，接收端为单声道并且码率为发送端一半
#define BROADCAST_AUTO_SWITCH_ROLE  1   //播放和暂停自动切换发射和接收状态
//若打开广播，混响默认采样率设为48k
#undef TCFG_REVERB_SAMPLERATE_DEFUAL
#undef MIC_EFFECT_SAMPLERATE
#define TCFG_REVERB_SAMPLERATE_DEFUAL (48000)
#define MIC_EFFECT_SAMPLERATE			(48000L)
#else
...
#define CONNECTED_CENTRAL_CLOSE_EDR_CONN   0
#define CONNECTED_PERIPHERAL_CLOSE_EDR_CONN   0
#define CONNECTED_KEY_EVENT_SYNC    0
...
#define TCFG_DEC_OGG_VORBIS_ENABLE          DISABLE //ogg_vorbis 文件
#define TCFG_DEC_OGG_OPUS_ENABLE            DISABLE //ogg_opus 文件
...
//若配置1.1声道音效流程，需要将JLA_CODING_CHANNEL配置为2
...
#define TCFG_DATA0_IO                       IO_PORTA_08 //IIS输出IO
#define TCFG_DATA1_IO                       IO_PORTA_11 //IIS输入IO
...
#if TCFG_MIC_EFFECT_ENABLE && TCFG_APP_RECORD_EN
#undef RECORDER_MIX_EN
#define RECORDER_MIX_EN						ENABLE//混合录音使能, 需要录制例如蓝牙、FM、 LINEIN才开
#undef  TCFG_ENC_ADPCM_ENABLE
#define TCFG_ENC_ADPCM_ENABLE               ENABLE
#endif
#define TCFG_RECORD_FOLDER_DEV_ENABLE       DISABLE//音乐播放录音区分使能
#define RECORDER_MIX_BT_PHONE_EN			DISABLE//电话录音使能
#define RECORDING_DAC_ENABLE                DISABLE
#define TONE_RECORDER_MIX_EN                DISABLE



#if RECORDER_MIX_EN
#define  RECORDER_CODING_TYPE               2// 编码格式：0 = AUDIO_CODING_MP3,  1 = AUDIO_CODING_WAV,  2 = AUDIO_CODING_PCM //混响打开之后， 不支持AUDIO_CODING_MP3
#define  RECORDER_MIX_CHANNEL               2 //当前只支持单声道
#define  RECORDER_MIX_SAMPLERATE            (48000L) //通道没做SRC，请确认每个通道输入为与此采样率一致的音频数据
#else
#define  RECORDER_CODING_TYPE               2// 编码格式：0 = AUDIO_CODING_WAV,  1 = AUDIO_CODING_MP3  2 = AUDIO_CODING_PCM
#endif


#define RECORDER_INPUT_16BIT                0
#define RECORDER_INPUT_24BIT                1

#define RECORDER_ENC_OUTPUT_16BIT           0
#define RECORDER_ENC_OUTPUT_24BIT           1 //当前只有PCM文件编码格式支持24BIT以及32BIT
#define RECORDER_ENC_OUTPUT_32BIT           2
#define RECORDER_ENC_OUTPUT_32BIT_FLOAT     3

#if RECORDER_MIX_EN
#define  RECORDER_INPUT_BIT_WIDTH           TCFG_AUDIO_DAC_BIT_WIDTH
#elif (TCFG_AUDIO_ADC_BIT_MODE == ADC_BIT_WIDTH_24)&& (!TCFG_ADC_BIT_24_TO_16 )
#define  RECORDER_INPUT_BIT_WIDTH           RECORDER_INPUT_24BIT
#else
#define  RECORDER_INPUT_BIT_WIDTH           RECORDER_INPUT_16BIT
#endif

#if (RECORDER_INPUT_BIT_WIDTH == RECORDER_INPUT_24BIT)
#define RECORDER_OUTPUT_BIT_WIDTH           RECORDER_ENC_OUTPUT_24BIT
#elif (TCFG_AUDIO_DAC_BIT_WIDTH == DAC_24BIT_MODE) && (RECORDER_CODING_TYPE == 2)
#define RECORDER_OUTPUT_BIT_WIDTH           RECORDER_ENC_OUTPUT_24BIT
#else
#define RECORDER_OUTPUT_BIT_WIDTH           RECORDER_ENC_OUTPUT_16BIT
#endif
//*********************************************************************************//
//                                  linein配置                                     //
//*********************************************************************************//
...
#define TCFG_LINEIN_DETECT_ENABLE           ENABLE
#define TCFG_LINEIN_CHECK_PORT				IO_PORTA_10				// linein检测IO
...
#define TCFG_LINEIN_INPUT_WAY               LINEIN_INPUT_WAY_ADC	//JL701N仅支持数字通路（ADC通路)
...
#define TCFG_FM_INSIDE_ENABLE					DISABLE //JL701N不支持内置FM
...
#define TCFG_FM_INPUT_WAY                       LINEIN_INPUT_WAY_ADC	//JL701N仅支持数字通路（ADC通路)
...
#if AUDIO_VOCAL_REMOVE_EN && (TCFG_CONNECTED_ENABLE || TCFG_BROADCAST_ENABLE)
#define LIVE_CAPTURE_VOCAL_REMOVE_EN        1  //广播发送端做人声消除
#define LIVE_PLAYER_VOCAL_REMOVE_EN         0  //广播接收端做人声消除

#if  LIVE_CAPTURE_VOCAL_REMOVE_EN && LIVE_PLAYER_VOCAL_REMOVE_EN
#error  "LIVE_CAPTURE_VOCAL_REMOVE_EN 与 LIVE_PLAYER_VOCAL_REMOVE_EN 不可以一起开"
#endif

#else
#define LIVE_CAPTURE_VOCAL_REMOVE_EN        0  //广播发送端做人声消除
#define LIVE_PLAYER_VOCAL_REMOVE_EN         0  //广播接收端做人声消除
#endif
...
#if ((TCFG_AUDIO_DAC_BIT_WIDTH == DAC_24BIT_MODE)  || (TCFG_DYNAMIC_EQ_ENABLE && AUDIO_VBASS_CONFIG))
#undef AUDIO_VBASS_32BIT_OUT_EN
#define AUDIO_VBASS_32BIT_OUT_EN 1
#endif
//link volume
#define AUDIO_VBASS_LINK_VOLUME             0
#if (!AUDIO_VBASS_CONFIG)
#undef AUDIO_VBASS_LINK_VOLUME
#define AUDIO_VBASS_LINK_VOLUME             0
#endif

#define TCFG_MUSIC_HARMONIC_EXCITER_ENABLE 	0//音乐通路谐波激励器


#define MUSIC_EXT_EQ_AFTER_DRC              0     //drc后的eq
#define MUSIC_EXT_EQ2_AFTER_DRC             0     //drc后的eq2
...
//                       左声道输出全频，右声道输出低音
//*********************************************************************************//
#define EFFECT_AFTER_STEREO_MIX   0//音效在声道合并后处理
#define EFFECT_BEFORE_STEREO_MIX  1//音效在声道合并前处理
#define EFFECT_PROCESS_POITION_CONFIG    EFFECT_AFTER_STEREO_MIX
...
#if (EFFECT_PROCESS_POITION_CONFIG  ==  EFFECT_AFTER_STEREO_MIX)
#undef TCFG_EQ_SPILT_ENABLE
#define TCFG_EQ_SPILT_ENABLE  1
#undef MUSIC_EXT_EQ_SPILT
#define MUSIC_EXT_EQ_SPILT    1
#undef TCFG_DRC_SPILT_ENABLE
#define TCFG_DRC_SPILT_ENABLE  1

#define TCFG_DYNAMIC_EQ_SPILT_ENABLE 1
#define TCFG_DYNAMIC_EQ_PRO_SPILT_ENABLE 1
#define TCFG_VBASS_SPILT_ENABLE 1
#else
