...
#else
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,	    KEY_MIC_EFFECT_VOICE_CHANGER_LOOP,			KEY_NULL
#endif
    },
    [1] = {
...
const u16 pc_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [3] = {
        KEY_MUSIC_PREV,		KEY_VOL_DOWN,	KEY_VOL_DOWN,	KEY_NULL,		KEY_VOCAL_REMOVE_SWITCH,				KEY_NULL
    },
    [4] = {
        KEY_MUSIC_NEXT,		KEY_VOL_UP,		KEY_VOL_UP,		KEY_NULL,		KEY_REVERB_OPEN,		KEY_NULL
    },
