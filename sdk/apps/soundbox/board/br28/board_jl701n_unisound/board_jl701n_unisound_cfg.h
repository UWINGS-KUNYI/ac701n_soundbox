#ifndef CONFIG_BOARD_JL701N_UNISOUND_CFG_H
#define CONFIG_BOARD_JL701N_UNISOUND_CFG_H

#include "board_jl701n_unisound_global_build_cfg.h"

#ifdef CONFIG_BOARD_JL701N_UNISOUND_BOX
...
//                               语音唤醒音箱使能                                  //
//*********************************************************************************//
#define TCFG_CHARGE_DET_IO				   IO_PORTA_08 //充电检测
#define TCFG_PA_EN_IO					   IO_PORTA_06 //PA_EN(高电平使能),12V供电时应关闭
#define TCFG_12V_DET_IO					   IO_PORTB_09 //检测供电方式是否为12V火牛供电
#define TCFG_RF_PA_EN             		   IO_PORTC_03 //3.3V_EN
#define TCFG_RF_TX_EN             		   IO_PORTB_06
#define TCFG_RF_RX_EN             		   IO_PORTB_07
#define TCFG_UNISOUND_ENABLE               ENABLE

#if TCFG_UNISOUND_ENABLE
#define TCFG_MIC_REC_ENABLE				   DISABLE//使能导出传入/传出引擎的数据
#if TCFG_MIC_REC_ENABLE
#define TCFG_SSP_DATA_EXPORT			   DISABLE//将引擎库降噪后的数据导出
#define TCFG_RAW_DATA_EXPORT	           DISABLE//将三通道麦原始的数据导出
#endif
#endif
...
#define TCFG_IOKEY_MODE_ONE_PORT			IO_PORTB_05
...
/*PA*/
#define TCFG_AUDIO_DAC_PA_PORT              IO_PORTE_06 //PA_CTRL
...
#define TCFG_UNISOUND_ADC_MIC_CHA			(AUDIO_ADC_MIC_0 | AUDIO_ADC_MIC_1)//unisound 双麦
...
#define TCFG_BT_RF_USE_EXT_PA_ENABLE	          1   //是否使用外置PA
...
#define CONNECTED_RECEIVER_CLOSE_EDR_CONN   1
...
#define CONNECTED_TX_CHANNEL_SEPARATION 0   //发送端音频声道分离使能
#else
#define LEA_CIG_CENTRAL_EN          0
#define LEA_CIG_PERIPHERAL_EN       0
#define CONNECTED_RECEIVER_CLOSE_EDR_CONN   0
#define CONNECTED_KEY_EVENT_SYNC    0
...
#define TCFG_LINEIN_CHECK_PORT				IO_PORTG_02 			// linein检测IO
