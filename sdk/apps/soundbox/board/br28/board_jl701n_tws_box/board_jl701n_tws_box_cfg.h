#ifndef CONFIG_BOARD_JL701N_TWS_BOX_CFG_H
#define CONFIG_BOARD_JL701N_TWS_BOX_CFG_H

#include "board_jl701n_tws_box_global_build_cfg.h"

#ifdef CONFIG_BOARD_JL701N_TWS_BOX
...
#define CONFIG_TWS_PAIR_MODE          1 /* 开机自动配对 */
#else
#undef CONFIG_TWS_PAIR_MODE
#define CONFIG_TWS_PAIR_MODE          1 /* 开机自动配对 */
#endif

#ifndef CONFIG_TWS_CHANNEL_SELECT
#define CONFIG_TWS_CHANNEL_SELECT             0 //配对方式选择——主机固定做左耳
#else
...
#ifndef CONFIG_TWS_PAIR_MODE
#define CONFIG_TWS_PAIR_MODE          0 /* 按键发起配对 */
#else
#undef CONFIG_TWS_PAIR_MODE
#define CONFIG_TWS_PAIR_MODE          0 /* 按键发起配对 */
#endif
...
#ifndef CONFIG_TWS_CHANNEL_SELECT
#define CONFIG_TWS_CHANNEL_SELECT             3 //配对方式选择——双击发起配对的耳机做左耳
#else
#undef CONFIG_TWS_CHANNEL_SELECT
#define CONFIG_TWS_CHANNEL_SELECT             3 //配对方式选择——双击发起配对的耳机做左耳
#endif
...
#endif //CONFIG_BOARD_JL701N_TWS_BOX
#endif //CONFIG_BOARD_JL701N_TWS_BOX_CFG_H
