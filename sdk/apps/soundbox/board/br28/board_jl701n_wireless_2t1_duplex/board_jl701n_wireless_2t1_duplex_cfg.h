#ifndef CONFIG_BOARD_JL701N_WIRELESS_2T1_DUPLEX_CFG_H
#define CONFIG_BOARD_JL701N_WIRELESS_2T1_DUPLEX_CFG_H

#include "board_jl701n_wireless_2t1_duplex_global_build_cfg.h"

#ifdef CONFIG_BOARD_JL701N_WIRELESS_2T1_DUPLEX
...
//*********************************************************************************//
//                            wireless_2t1 duplex 配置                             //
//*********************************************************************************//
#define WIRELESS_2T1_DUPLEX_EN				ENABLE
#define WIRELESS_PAIR_BONDING				DISABLE

#define ROLE_CENTRAL                        1
#define ROLE_PERIP                          2
#define WIRELESS_2T1_DUPLEX_ROLE            ROLE_PERIP
...
//                                 USB 配置                                        //
//*********************************************************************************//
#define CIG_PERIP_UAC_ENABLE                DISABLE

#if (WIRELESS_2T1_DUPLEX_ROLE == ROLE_CENTRAL)||((WIRELESS_2T1_DUPLEX_ROLE == ROLE_PERIP)&&CIG_PERIP_UAC_ENABLE)
#define TCFG_PC_ENABLE						ENABLE_THIS_MOUDLE//PC模块使能
#elif (WIRELESS_2T1_DUPLEX_ROLE == ROLE_PERIP)
...
#define USB_PC_NO_APP_MODE                  ENABLE_THIS_MOUDLE
...
#define AUDIO_EFFECTS_VOICE_CHANGER_AT_RAM  0
#define AUDIO_STREAM_AT_RAM                 0
#define AUDIO_EFFECTS_DVOL_AT_RAM           0
#define AUDIO_EFFECTS_CONVERT_DATA_AT_RAM   0
#define AUDIO_EFFECTS_HARMONIC_EXCITER_RAM  0
...
//                               声卡功能相关配置                                  //
//*********************************************************************************//
#if (WIRELESS_2T1_DUPLEX_ROLE == ROLE_CENTRAL)
#define SOUNDCARD_ENABLE                    ENABLE
#define MULTI_AUDIO_UPLOAD_TO_UAC_ENABLE    ENABLE //非声卡方案的多音频UAC传输配置
#elif ((WIRELESS_2T1_DUPLEX_ROLE == ROLE_PERIP)&&CIG_PERIP_UAC_ENABLE)
#define SOUNDCARD_ENABLE                    ENABLE
#define MULTI_AUDIO_UPLOAD_TO_UAC_ENABLE    ENABLE //非声卡方案的多音频UAC传输配置
#else
...
#undef USB_PC_NO_APP_MODE
#define USB_PC_NO_APP_MODE                  ENABLE
#endif
...
#define TCFG_MIC_EFFECT_ENABLE       	ENABLE_THIS_MOUDLE
...
#define WIRELESS_MASTER_MIC_EFFECT_ENABLE   ENABLE //主机发送前做mic音效
#define WIRELESS_MIC_EFFECT_ASYNC_EN        ENABLE
#endif
...
#define TCFG_CONNECTED_ENABLE       ENABLE_THIS_MOUDLE
...
#if WIRELESS_2T1_DUPLEX_ROLE == ROLE_CENTRAL
#define LEA_CIG_CONNECTION_NUM      2   //配置连接设备数，最大配置为2
#else
#define LEA_CIG_CONNECTION_NUM      1   //配置连接设备数，最大配置为2
#endif
#define CONNECTED_TX_LOCAL_DEC_EN   0   //CIG音频发送端是否解码发送的音频
#define CONNECTED_TX_CHANNEL_SEPARATION 1   //发送端音频声道分离使能，要求发送端为双声道，接收端为单声道并且码率为发送端一半
#define CONNECTED_ROLE_CONFIG       WIRELESS_2T1_DUPLEX_ROLE //固定CIG主从, 配0不固定角色，配1做主机，配2做从机
#else
...
#define CONNECTED_ROLE_CONFIG       0
#endif

#define CIG_TRANSPORT_MODE          2//双工通信方式

#define CIG_CENTRAL_TRANSIT_MONO           DISABLE
#define CIG_PERIP_TRANSIT_STEREO           DISABLE

#if CIG_CENTRAL_TRANSIT_MONO || CIG_PERIP_TRANSIT_STEREO
#undef CONNECTED_TX_CHANNEL_SEPARATION
#define CONNECTED_TX_CHANNEL_SEPARATION 0
#endif


#if ((WIRELESS_2T1_DUPLEX_ROLE == ROLE_PERIP)&&CIG_PERIP_UAC_ENABLE)
#define CIG_PERIP_MULTI_CAPTURE_EN         ENABLE
#else
#define CIG_PERIP_MULTI_CAPTURE_EN         DISABLE
#endif
#if CIG_PERIP_MULTI_CAPTURE_EN && (WIRELESS_2T1_DUPLEX_ROLE == ROLE_PERIP)
#undef WIRELESS_MIC_EFFECT_ASYNC_EN
#define WIRELESS_MIC_EFFECT_ASYNC_EN       DISABLE
#endif
//*********************************************************************************//
//                                  AI配置                                       //
...
#if (WIRELESS_2T1_DUPLEX_ROLE == ROLE_CENTRAL)||(WIRELESS_2T1_DUPLEX_ROLE == ROLE_PERIP && CIG_PERIP_TRANSIT_STEREO)
#define JLA_CODING_CHANNEL     2  		//JLA 的通道数 其他参数不变，实际单声道的码率是双声道码率的 2 倍;
#elif (WIRELESS_2T1_DUPLEX_ROLE == ROLE_PERIP && !CIG_PERIP_TRANSIT_STEREO)
...
#else
#define JLA_CODING_BIT_RATE    48000  		//JLA 的码率 广播时 若码率大于96K,需要修改每次传输数据大小为 1 帧编码长度;
#endif
...
#elif (WIRELESS_2T1_DUPLEX_ROLE == ROLE_PERIP)
#define TCFG_LINEIN_ENABLE					DISABLE_THIS_MOUDLE		// linein使能
#endif
...
#define EFFECT_PROCESS_POITION_CONFIG    EFFECT_BEFORE_STEREO_MIX
...
#endif //CONFIG_BOARD_JL701N_WIRELESS_2T1_DUPLEX
#endif //CONFIG_BOARD_JL701N_WIRELESS_2T1_DUPLEX_CFG_H
