...
#undef CONFIG_TWS_COMMON_ADDR_SELECT
...
#define CONFIG_TWS_PAIR_MODE           CONFIG_TWS_PAIR_BY_CLICK /*注意:自动配对或者按键配对开启, 可能会产生生产线混配情况，
...
#define CONFIG_TWS_DISCONN_NO_RECONN                  1    /* 按键断开tws 不会回连 调用  tws_api_detach(TWS_DETACH_BY_REMOVE_NO_RECONN);*/
/* 声道确定方式选择 */
...
//                                  uart 1t2配置                                   //
//*********************************************************************************//
#define TCFG_UART_1T2_EN                    DISABLE_THIS_MOUDLE
#define TCFG_UART_1T2_PORT					IO_PORTA_00

#define UART_1T2_ROLE_MASTER				0
#define UART_1T2_ROLE_SLAVE1				1
#define UART_1T2_ROLE_SLAVE2				2

//配置角色
#define UART_1T2_ROLE						UART_1T2_ROLE_MASTER
#define UART_1T2_SLAVE_NUM					2	 // 限制选1-2，该选项只对主机有效，用于查询俩从机的命令，当选项为1时，从机只能选SLAVE1
