...
enum {
    ...
    KEY_REVERB_GAIN1_UP,
    KEY_REVERB_GAIN2_UP,
    KEY_MIC_EFFECT_REVERB_ONOFF,
    KEY_MIC_EFFECT_ECHO_ONOFF,
    KEY_MIC_EFFECT_HOWLING_ONOFF,
    KEY_MIC_EFFECT_LLNS_ONOFF,
    KEY_MIC_EFFECT_VOICE_CHANGER_ONOFF,
    KEY_MIC_EFFECT_VOICE_CHANGER_LOOP,
    KEY_AUDIO_VBASS_ONOFF,
...
///旋钮按键
    ...
    KEY_BROADCAST_SW,
    KEY_CONNECTED_SW,
    KEY_CONNECTED_ROLE_SW,
    KEY_WIRELESS_TRANS_MODE_SW,
    KEY_WIRELESS_AUTH_ENTER,
    KEY_WIRELESS_AUTH_EXIT,
    KEY_WIRELESS_PAIR_INFO_REMOVE,
    //不会出现在按键主流程，用于不重要得其他操作
    KEY_MINOR_OPT,

    KEY_MIC_START,

    KEY_DIG_GROUP_MIC_PP,
    KEY_DIG_GROUP_LINEIN_PP,
    KEY_DIG_GROUP_IIS_IN_PP,
    KEY_DIG_GROUP_PC_PP,
    KEY_DIG_GROUP_LIVE_PLAYER_PP,
    KEY_DIG_GROUP_LIVE_CAPTURE_PP,

    KEY_MULTI_CAPTURE_MIC_PP,
    KEY_VOCAL_REMOVE_SWITCH,
    KEY_NULL = 0xFFFF,
