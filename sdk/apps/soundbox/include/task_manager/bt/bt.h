...
#if((TCFG_UI_ENABLE && TCFG_SPI_LCD_ENABLE)||WIRELESS_2T1_DUPLEX_EN)//点阵屏断开蓝牙连接时可选择不跳回蓝牙模式
...
#if (TCFG_USER_TWS_ENABLE && TCFG_BROADCAST_ENABLE)
#define WIRELESS_TRANS_DEFAULT_MODE   WIRELESS_TRANS_BT_MODE
#elif (TCFG_USER_TWS_ENABLE)
#define WIRELESS_TRANS_DEFAULT_MODE   WIRELESS_TRANS_TWS_MODE
#elif (TCFG_BROADCAST_ENABLE)
#define WIRELESS_TRANS_DEFAULT_MODE   WIRELESS_TRANS_BIG_MODE
#elif (TCFG_CONNECTED_ENABLE)
#define WIRELESS_TRANS_DEFAULT_MODE   WIRELESS_TRANS_CIG_MODE
#else
#define WIRELESS_TRANS_DEFAULT_MODE   WIRELESS_TRANS_BT_MODE
#endif
