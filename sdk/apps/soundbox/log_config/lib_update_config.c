...
const int config_update_mode = UPDATE_STORAGE_DEV_EN | UPDATE_UART_EN;
#else
const int config_update_mode = UPDATE_BT_LMP_EN | UPDATE_STORAGE_DEV_EN | UPDATE_UART_EN | UPDATE_APP_EN | UPDATE_BLE_TEST_EN;
#endif
#endif
#endif
#endif
...
//是否支持升级之后保留vm数据
#if (((defined CONFIG_CPU_BR25) || (defined CONFIG_CPU_BR23) || (defined CONFIG_CPU_BR28)) && RCSP_MODE)
