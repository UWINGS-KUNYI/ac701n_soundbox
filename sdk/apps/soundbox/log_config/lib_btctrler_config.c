...
#if (BT_FOR_APP_EN || TCFG_USER_BLE_ENABLE || LEA_BIG_CTRLER_TX_EN || LEA_BIG_CTRLER_RX_EN || LEA_CIG_CENTRAL_EN || LEA_CIG_PERIPHERAL_EN)

const int config_btctler_modules        = BT_MODULE_CLASSIC | BT_MODULE_LE;

#else //#if (BT_FOR_APP_EN || TCFG_USER_BLE_ENABLE || LEA_BIG_CTRLER_TX_EN || LEA_BIG_CTRLER_RX_EN || LEA_CIG_CENTRAL_EN || LEA_CIG_PERIPHERAL_EN)
...
#endif //#if (BT_FOR_APP_EN || TCFG_USER_BLE_ENABLE || LEA_BIG_CTRLER_TX_EN || LEA_BIG_CTRLER_RX_EN || LEA_CIG_CENTRAL_EN || LEA_CIG_PERIPHERAL_EN)
...
#if (TCFG_USER_BLE_ENABLE || LEA_BIG_CTRLER_TX_EN || LEA_BIG_CTRLER_RX_EN || LEA_CIG_CENTRAL_EN || LEA_CIG_PERIPHERAL_EN)
        | BT_MODULE_LE
#endif//TCFG_USER_BLE_ENABLE
        ;
...
const int CONFIG_A2DP_MAX_BUF_SIZE          = 40 * 1024;
#else
...
#if (TCFG_USER_BLE_ENABLE && !TCFG_BROADCAST_ENABLE && !TCFG_CONNECTED_ENABLE)
/*confirm config*/
...
const uint64_t config_btctler_le_features = LE_FEATURES_CIS | LE_CORE_V50_FEATURES;
 ...
 */
/*-----------------------------------------------------------*/
#if ((!TCFG_USER_BT_CLASSIC_ENABLE) && TCFG_USER_BLE_ENABLE)||TCFG_CONNECTED_ENABLE||TCFG_BROADCAST_ENABLE
