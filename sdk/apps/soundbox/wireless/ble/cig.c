...
static int cig_central_ioctrl(int op, ...)
{
    ...
    case WIRELESS_DEV_OP_SET_SYNC:
        cig_central_ops.sync_set(va_arg(argptr, uint16_t), va_arg(argptr, uint8_t));
        break;

    case WIRELESS_DEV_OP_GET_SYNC:
        cig_central_ops.sync_get(va_arg(argptr, uint16_t), (uint16_t *)va_arg(argptr, int), (uint32_t *)va_arg(argptr, int), (uint32_t *)va_arg(argptr, int));
        break;
...
static int cig_perip_ioctrl(int op, ...)
{
    ...
    case WIRELESS_DEV_OP_SET_SYNC:
        cig_perip_ops.sync_set(va_arg(argptr, uint16_t), va_arg(argptr, uint8_t));
        break;

    case WIRELESS_DEV_OP_GET_SYNC:
        cig_perip_ops.sync_get(va_arg(argptr, uint16_t), (uint16_t *)va_arg(argptr, int), (uint32_t *)va_arg(argptr, int), (uint32_t *)va_arg(argptr, int));
        break;
