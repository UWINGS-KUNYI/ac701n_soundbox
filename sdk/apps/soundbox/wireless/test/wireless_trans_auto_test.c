...
void wireless_trans_auto_test1(void *p)
{
    static u8 sw_flag = 0;
    if (!auto_test_timer1) {
        return;
    ...
    app_task_put_key_msg(KEY_CONNECTED_SW, 0);
...
{
    if (!auto_test_timer1) {
        auto_test_timer1 = sys_timer_add(NULL, wireless_trans_auto_test1, 10 * 1000);
    }
}

void wireless_trans_auto_test2(void *p)
{
    if (!auto_test_timer2) {
        return;
    }
...
{
    if (!auto_test_timer2) {
        auto_test_timer2 = sys_timer_add(NULL, wireless_trans_auto_test2, 10 * 1000);
    }
}

void wireless_trans_auto_test3(void *p)
{
    static u8 sw_flag = 0;
    if (!auto_test_timer3) {
        return;
...
{
    if (!auto_test_timer3) {
        auto_test_timer3 = sys_timer_add(NULL, wireless_trans_auto_test3, 10 * 1000);
    }
}

void wireless_trans_auto_test4(void *p)
{
    static u8 sw_flag = 0;
    if (!auto_test_timer4) {
        return;
...
{
    if (!auto_test_timer4) {
        auto_test_timer4 = sys_timer_add(NULL, wireless_trans_auto_test4, 10 * 1000);
    }
}
