...
const char *tone_table[] = {
    ...
    [IDEX_TONE_SD] 				= TONE_RES_ROOT_PATH"tone/tf_card.*",
    [IDEX_TONE_VOICE] 		    = TONE_RES_ROOT_PATH"tone/voice_mode.*",
    [IDEX_TONE_SPEECH_START]	= TONE_NORMAL,//TONE_RES_ROOT_PATH"tone/speech.*",
    [IDEX_TONE_BROADCAST_OPEN]  = TONE_RES_ROOT_PATH"tone/big_mode.*",
    [IDEX_TONE_BROADCAST_CLOSE] = TONE_RES_ROOT_PATH"tone/big_close.*",
    [IDEX_TONE_CONNECTED_OPEN]  = TONE_RES_ROOT_PATH"tone/cig_mode.*",
    [IDEX_TONE_CONNECTED_CLOSE] = TONE_RES_ROOT_PATH"tone/cig_close.*",
    [IDEX_TONE_TWS_OPEN]        = TONE_RES_ROOT_PATH"tone/tws_mode.*",
    [IDEX_TONE_TWS_CLOSE]       = TONE_RES_ROOT_PATH"tone/tws_close.*",
    [IDEX_TONE_MIC]             = TONE_RES_ROOT_PATH"tone/mic_mode.*",
    [IDEX_TONE_IIS]             = TONE_RES_ROOT_PATH"tone/iis_in_mode.*",
    [IDEX_TONE_BT_COMMON]       = TONE_RES_ROOT_PATH"tone/bt_common.*",
};
