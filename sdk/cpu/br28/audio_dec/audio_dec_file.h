...
#ifndef ___AU___DIO_DEC_FILE_H_
#define ___AU___DIO_DEC_FILE_H_
...
struct file_dec_hdl {
    ...
    struct fixphase24bit_repair_obj repair_buf_24bit;	// 无缝循环句柄
#else
    ...
    struct file_dec_src_hdl src_hdl;
...
bool file_decoder_is_fade_in_out(struct file_decoder *file_dec);
struct file_decoder *file_dec_get_file_decoder_hdl(void);
int file_decoder_fade_out(struct file_decoder *file_dec);

#define file_dec_is_fade_in_out()       file_decoder_is_fade_in_out(file_dec_get_file_decoder_hdl())
...
#define file_dec_fade_out()				file_decoder_fade_out(file_dec_get_file_decoder_hdl())
