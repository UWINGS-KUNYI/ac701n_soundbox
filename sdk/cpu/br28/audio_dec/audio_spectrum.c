...
spectrum_fft_hdl *spectrum_open_demo(u32 sr, u8 channel)
{
    ...
    parm.mode = 2;
    parm.pcm_info.IndataBit = global_bit_wide;
    parm.pcm_info.OutdataBit = global_bit_wide;
    parm.pcm_info.IndataInc = (channel == 2) ? 2 : 1;
    parm.pcm_info.OutdataInc = (channel == 2) ? 2 : 1;
