...
#define EFF_DIR effect_file_24bit
#else
...
#if defined(SOUND_TRACK_1_P_1_CH_CONFIG) && SOUND_TRACK_1_P_1_CH_CONFIG
cp ./EFF_DIR/music_1to1.bin eq_cfg_hw.bin
#elif defined(WIRELESS_SOUND_TRACK_2_P_X_ENABLE)&&WIRELESS_SOUND_TRACK_2_P_X_ENABLE
cp ./EFF_DIR/music_2to1_2to2_sur_max.bin eq_cfg_hw.bin
...
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO_ADVANCE)
cp ./EFF_DIR/mic_effect_full_advance.bin eq_cfg_hw.bin
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO) && defined(TCFG_MIC_HARMONIC_EXCITER_ENABLE) && TCFG_MIC_HARMONIC_EXCITER_ENABLE
cp ./EFF_DIR/mic_effect_full_harmonic_exciter.bin eq_cfg_hw.bin
...
#elif AUDIO_SURROUND_CONFIG && AUDIO_VBASS_CONFIG && (AUDIO_VBASS_32BIT_OUT_EN == 0)
cp ./EFF_DIR/music_base_surround_vbass.bin eq_cfg_hw.bin
#elif defined(AUDIO_SURROUND_CONFIG) && AUDIO_SURROUND_CONFIG
cp ./EFF_DIR/music_base_surround.bin eq_cfg_hw.bin
#elif defined(AUDIO_VBASS_CONFIG) && AUDIO_VBASS_CONFIG
cp ./EFF_DIR/music_base_vbass.bin eq_cfg_hw.bin
#else
...
#endif
#if defined(SOUND_TRACK_1_P_1_CH_CONFIG) && SOUND_TRACK_1_P_1_CH_CONFIG
copy .\EFF_DIR\music_1to1.bin eq_cfg_hw.bin
#elif defined(WIRELESS_SOUND_TRACK_2_P_X_ENABLE)&&WIRELESS_SOUND_TRACK_2_P_X_ENABLE
copy .\EFF_DIR\music_2to1_2to2_sur_max.bin eq_cfg_hw.bin
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB) && TCFG_AUDIO_MIC_EFFECT_POST_EQ_ENABLE
...
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO_ADVANCE)
copy .\EFF_DIR\mic_effect_full_advance.bin eq_cfg_hw.bin
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO)&& defined(TCFG_MIC_HARMONIC_EXCITER_ENABLE) && TCFG_MIC_HARMONIC_EXCITER_ENABLE
copy .\EFF_DIR\mic_effect_full_harmonic_exciter.bin eq_cfg_hw.bin
#elif defined(TCFG_MIC_EFFECT_ENABLE)&& TCFG_MIC_EFFECT_ENABLE && (TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO)
...
#elif AUDIO_SURROUND_CONFIG && AUDIO_VBASS_CONFIG && (AUDIO_VBASS_32BIT_OUT_EN == 0)
copy .\EFF_DIR\music_base_surround_vbass.bin eq_cfg_hw.bin
#elif defined(AUDIO_SURROUND_CONFIG) && AUDIO_SURROUND_CONFIG
copy .\EFF_DIR\music_base_surround.bin eq_cfg_hw.bin
#elif defined(AUDIO_VBASS_CONFIG) && AUDIO_VBASS_CONFIG
copy .\EFF_DIR\music_base_vbass.bin eq_cfg_hw.bin
#else
