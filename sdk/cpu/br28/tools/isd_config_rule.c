...
SDK_VERSION = JL701N_V1.4.2; //jenkins脚本生成
...
[FW_ADDITIONAL]
#if ((RCSP_MODE != RCSP_MODE_OFF) && ((defined(TCFG_BROADCAST_ENABLE) && (TCFG_BROADCAST_ENABLE == 1)) || (defined(TCFG_CONNECTED_ENABLE) && (TCFG_CONNECTED_ENABLE == 1))))
FILE_LIST = (file = ota.bin: type = 100), (file = config.dat: type = 0xfb),\
(file = file--authrun-JL701N-id-555.tkn:type=0xec)
#else
...
SD_LATCH_IO = PB02_PB08   //SD卡升级需要锁住的io,最大限制10个io
#endif
