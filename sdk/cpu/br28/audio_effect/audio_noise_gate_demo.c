...
NOISEGATE_API_STRUCT *audio_noisegate_open_demo(u32 ns_name, u32 sample_rate, u32 ch_num)
{
    ...
    noisegate_parm.pcm_info.IndataBit = global_bit_wide;
    noisegate_parm.pcm_info.OutdataBit = global_bit_wide;
    noisegate_parm.pcm_info.IndataInc = (ch_num == 1) ? 1 : 2;
    noisegate_parm.pcm_info.OutdataInc = (ch_num == 1) ? 1 : 2;
    noisegate_parm.pcm_info.Qval = global_bit_wide ? 23 : 15;
