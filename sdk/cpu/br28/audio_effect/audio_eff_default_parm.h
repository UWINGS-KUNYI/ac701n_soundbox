...
#define AUDIO_ADC_PGA_CONFIG 1

#define HIGH_GRADE_LOW_PASS_FILTER_EN  0//高阶低通滤波器

#define MUSIC_NOISE_GATE_EN    0//音乐通路的noisegate，默认串在vbass之后
...
struct eff_parm {
    ...
    harmonic_exciter_param_tool_set exciter_parm;
};
#if ((TCFG_MIC_EFFECT_SEL == MIC_EFFECT_REVERB_ECHO_ADVANCE) || TCFG_MIC_EFFECT_MDRC)
extern struct nband_drc mic_last_drc_parm[EFFECT_REVERB_PARM_MAX];
#endif
...
extern struct eq_tool_mic_dut mic_dut_eq;
...
extern harmonic_exciter_param_tool_set music_exciter_parm;
extern DynamicEQProParam_TOOL_SET  dynamic_eq_pro[mode_add];
...
extern void audio_linein_set_gain(int gain);
...
void audio_dynamic_eq_pro_update_parm_api(u32 dynamic_eq_name, DynamicEQProParam_TOOL_SET  *parm);
