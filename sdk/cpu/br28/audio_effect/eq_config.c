...
#if defined(EXT_HP_LP_SECTIONS) && EXT_HP_LP_SECTIONS
    {10, EQ_IIR_TYPE_HIGH_PASS_ADVANCE, 20,    0, 0.7f},
    {11, EQ_IIR_TYPE_LOW_PASS_ADVANCE, 18000, 0, 0.7f},
#endif
};
...
int eq_init(void)
{
    ...
    int cpu_section = 0;
    int EQ_PRIV_SECTION_NUM = 10;//hw nsection per ch
