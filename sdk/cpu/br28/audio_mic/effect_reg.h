...
extern const struct  plate_reverb_update_parm 		effect_plate_reverb_parm_default;
extern const EF_REVERB_FIX_PARM 					effect_echo_fix_parm_default;
extern const struct echo_update_parm 							effect_echo_parm_default;
// extern const PITCH_SHIFT_PARM	 					effect_pitch_parm_default;
extern const NoiseGateParam 						effect_noisegate_parm_default;
extern const NotchHowlingParam                       howling_param_default;
