...
#define TCFG_DIG_PHASE_INVERTER_EN		0   //数字反相器，用来矫正DAC的输出相位(JL701N输出正相，默认关)
...
// 当单独调节解码通道音量时，使用下列命令可以调节单独的解码音量。
// (仅当SYS_VOL_TYPE == VOL_TYPE_DIGGROUP时有效)
#define APP_AUDIO_STATE_MUSIC_CH_BASE       10
#define APP_AUDIO_STATE_CH_A2DP             11
#define APP_AUDIO_STATE_CH_PC               12
#define APP_AUDIO_STATE_CH_FILE             13
#define APP_AUDIO_STATE_CH_LINEIN           14
#define APP_AUDIO_STATE_CH_FM               15
...
#define AUDIO_SYNTHESIS_LEN  2048
...
void app_audio_bt_set_volume(u8 state, s8 volume, u8 fade);
