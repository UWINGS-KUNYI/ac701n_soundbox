...
#define KEY_EVENT_FROM_CIG             (('C' << 24) | ('I' << 16) | ('G' << 8) | '\0')
#define SYS_BT_EVENT_FROM_BIG          (('B' << 24) | ('I' << 16) | ('G' << 8) | '\0')
#define SYS_BT_EVENT_FROM_CIG          (('C' << 24) | ('I' << 16) | ('G' << 8) | '\0')
...
struct sys_event {
    ...
    union {
        ...
        struct wireless_trans_event wireless_trans;
    } u;
};
