...
extern const int plate_reverb_mode;
enum {
    REVERB_ORINGIN_MODE = 0,
    REVERB_ADVANCE_MODE,
};
 ...
 *  plate声卡混响参数更新
 */
void update_plate_reverb_parm(PLATE_REVERB_API_STRUCT *reverb_api_obj, struct  plate_reverb_update_parm *reverb_seting);
 ...
 * 更新echo混响通用参数
 */
void update_echo_parm(ECHO_API_STRUCT *echo_api_obj, struct echo_update_parm *echo_seting);
/*
 * 更新echo混响gain参数
 */
