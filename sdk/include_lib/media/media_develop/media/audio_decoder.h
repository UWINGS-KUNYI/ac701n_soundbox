...
struct fixphase24bit_repair_obj {
    int fifo_buf[18 + 12][32][2];
};
/*
 * 循环播放结构体
...
void audio_decoder_dual_switch_32bit(u8 ch_type, u8 half_lr, s32 *data, int len);
/*
*********************************************************************
...
*********************************************************************
*/
int audio_decoder_get_bit_width(void *_dec);
/*
*********************************************************************
*                  Audio Decoder Get codec_version
* Description: 获取配置的解码采样率
* Arguments  : *_dec	解码句柄
...
*********************************************************************
*/
int audio_decoder_get_codec_version(void *_dec);
/*
*********************************************************************
