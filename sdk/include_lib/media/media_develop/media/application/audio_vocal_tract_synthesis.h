...
*/
/*----------------------------------------------------------------------------*/
int audio_vocal_tract_open(struct audio_vocal_tract *vocal_tract, int len);

void audio_vocal_tract_set_info(struct audio_vocal_tract *vocal_tract, struct vocal_track_parm par);
/*----------------------------------------------------------------------------*/
/**@brief   关闭声道合并
   @param   *vocal_tract: 句柄
   @return
