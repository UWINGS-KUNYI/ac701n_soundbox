...
#define AUDIO_CODING_JLA          0x02000000
#define AUDIO_CODING_OGG          0x04000000
#define AUDIO_CODING_LHDC      	  0x08000000
...
enum audio_channel {
    ...
    AUDIO_CH_DUAL_DIFF,  	//双声道为差分

    AUDIO_CH_LR_FIXED = 0x80,  //固定立体声
    AUDIO_CH_MAX = 0xff,
};

#define AUDIO_CH_IS_MONO(ch)	(((ch)==AUDIO_CH_L) || ((ch)==AUDIO_CH_R) || ((ch)==AUDIO_CH_DIFF))
#define AUDIO_CH_IS_DUAL(ch)	(((ch)==AUDIO_CH_LR) || ((ch)==AUDIO_CH_DUAL_L) || ((ch)==AUDIO_CH_DUAL_R) || ((ch)==AUDIO_CH_DUAL_DIFF))
...
struct audio_fmt {
    ...
    u32 complexity;
    void *priv;
    u8  bit_width; //0:16 位， 1:24位
    u16 codec_version; //编码类型的版本
};
