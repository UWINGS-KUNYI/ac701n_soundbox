...
// 单声道转双声道差分
void pcm_single_to_dual_diff(void *out, void *in, u16 len);
// 单声道转四声道
...
void pcm_dual_to_dual_or_single_32bit(u8 ch_type, u8 half_lr, s32 *odata, s32 *idata, int len);
void pcm_single_to_dual_diff_32bit(void *out, void *in, u16 len);
