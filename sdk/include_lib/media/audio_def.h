...
#define AUD_OSC_CLK     0
#define AUD_DIG_CLK     1
...
//> Bit Width Define
#define DAC_16BIT_MODE          0
#define DAC_24BIT_MODE          1
...
//> Bit Width Define
#define ADC_BIT_WIDTH_16       (0)
#define ADC_BIT_WIDTH_24       (1)
...
#define AUDIO_WAY_TYPE_DAC_IIS      (AUDIO_WAY_TYPE_IIS | AUDIO_WAY_TYPE_DAC)
...
#define  BIT_WIDE_32BIT  			2
#define  BIT_WIDE_32BIT_FLOAT  		3

//不同位宽饱和范围
#define PCM_16BIT_SAT_MAX		(32767)
#define PCM_16BIT_SAT_MIN		(-32768)
#define PCM_24BIT_SAT_MAX		(8388607)
#define PCM_24BIT_SAT_MIN		(-8388608)
